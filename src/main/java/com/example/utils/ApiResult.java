...
public abstract class ApiResult implements Serializable {
    ...
    public static ApiResult success() {
        return new com.example.utils.SuccessApiResult();
    }
    ...
    public static <T> ApiResult success(T data) {
        return new com.example.utils.SuccessApiResult<T>(data);
    }
    ...
    public static ApiResult error(Integer code, String message) {
        return new com.example.utils.ErrorApiResult(code, message);
    }
